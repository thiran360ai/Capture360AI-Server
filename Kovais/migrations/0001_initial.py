# Generated by Django 5.0.7 on 2025-03-24 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emblem_url', models.URLField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(blank=True, choices=[('men', 'Men'), ('women', 'Women'), ('kids', 'Kids')], max_length=20, null=True)),
                ('service_name', models.CharField(blank=True, max_length=50, null=True)),
                ('service_images', models.JSONField(default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_out', models.DateTimeField(blank=True, null=True)),
                ('category', models.CharField(blank=True, max_length=255, null=True)),
                ('room_count', models.CharField(blank=True, max_length=255, null=True)),
